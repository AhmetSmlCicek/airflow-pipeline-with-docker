...
usedurls_path = os.path.join(os.getcwd(),'data/used_urls.csv')

with open(usedurls_path, 'r') as f:
    reader = csv.reader(f)
...
def create_csv_file():
    ...
    csv_file = os.path.join(os.getcwd(),'data/new_entries.csv')
...
if __name__ == '__main__':
    ...
    print(new_urls)
    new_urls_list = [char.split(',') for char in new_urls]
   
    with open(usedurls_path, 'a+', newline='') as file_url:
    ...
    main_file = os.path.join(os.getcwd(),'data/Property_structured_data .csv')
    df_main = pd.read_csv(main_file)
    df_main = pd.concat([df_main,df_new])
    
    with open (main_file,'w') as mainfile:
        df_main.to_csv(mainfile)
    
    upload_file(csv_file,'ahmet_newentries.csv')
    upload_file(main_file,'ahmet_main.csv')
    upload_file(usedurls_path,'ahmet_usedurls.csv')
    download_path = os.path.join(os.getcwd(),'data/ahmet_newentries.csv')
    download_file(download_path,'ahmet_newentries.csv')