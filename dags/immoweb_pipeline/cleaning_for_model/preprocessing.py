...
mainfile_path = os.path.join(os.getcwd(),'data/main_downloaded.csv')
download_file(mainfile_path,'ahmet_main.csv')

cleanedfile_path = os.path.join(os.getcwd(),'data/cleaned_downloaded.csv')
download_file(cleanedfile_path,'ahmet_new_cleaned.csv')

main_df = pd.read_csv(mainfile_path)
new_df = pd.read_csv(
...
model_file = os.path.join(os.getcwd(),'data/dataset_for_model.csv')

with open(model_file, 'w') as file_model:
    df.to_csv(file_model, index=False)

upload_file(model_file,'ahmet_modeldataset.csv')